...
clinic_efficiency = min(filtered_df['زيارات العيادة'].mean() / 1000 * 100, 100) if filtered_df['زيارات العيادة'].mean() > 0 else 0
    ...
    with col1:
        if show_predictions:
            ...
            if len(travelers) >= 3:
                ...
                predicted_travelers = travelers[-3:] * 1.1  # افتراض زيادة 10%
